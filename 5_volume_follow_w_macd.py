...
# 60일 거래량 평균 대비 60일내 일일 최대 거래량이 500% 이상인 종목 추출(세력 매수)
# 위의 종목 중 macd > 0 인 종목 추출
# 일 1회 가동!!!(macd 0선 위 올라오는 신규종목 도출)
...
wb.save('5_volume_follow_w_macd.xlsx')

#회사 데이터 읽기
df_com = pd.read_excel("5_volume_follow.xlsx")
